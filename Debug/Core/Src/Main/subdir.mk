...
CPP_SRCS += \
../Core/Src/Main/drone.cpp 

OBJS += \
./Core/Src/Main/drone.o 

CPP_DEPS += \
./Core/Src/Main/drone.d 
...
clean-Core-2f-Src-2f-Main:
	-$(RM) ./Core/Src/Main/drone.cyclo ./Core/Src/Main/drone.d ./Core/Src/Main/drone.o ./Core/Src/Main/drone.su
